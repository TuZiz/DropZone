...
object LangKeys {
    ...
    const val CLAIM_SUCCESS = "claim-success"
    const val CLAIM_ALREADY_CLAIMED = "claim-already-claimed"
    const val CLAIM_FAILED = "claim-failed"
    const val NAVIGATION_ACTIONBAR = "navigation-actionbar"
    const val NAVIGATION_ACTIONBAR_EMPTY = "navigation-actionbar-empty"
    const val DIRECTION_FRONT = "direction-front"
    const val DIRECTION_FRONT_LEFT = "direction-front-left"
    const val DIRECTION_LEFT = "direction-left"
    const val DIRECTION_BACK_LEFT = "direction-back-left"
    const val DIRECTION_BACK = "direction-back"
    const val DIRECTION_BACK_RIGHT = "direction-back-right"
    const val DIRECTION_RIGHT = "direction-right"
    const val DIRECTION_FRONT_RIGHT = "direction-front-right"
    ...
    const val DBSTATUS_LOCAL = "dbstatus-local"
    const val DBSTATUS_CONNECTED = "dbstatus-connected"
    const val DBSTATUS_FAILED = "dbstatus-failed"
    const val CROSS_SERVER_SYNC_COMPLETE = "cross-server-sync-complete"
    const val REWARD_OUTBOX_PENDING = "reward-outbox-pending"
    const val REWARD_OUTBOX_DONE = "reward-outbox-done"
    const val REWARD_OUTBOX_FAILED = "reward-outbox-failed"
    const val OUTBOX_STATS = "outbox-stats"
